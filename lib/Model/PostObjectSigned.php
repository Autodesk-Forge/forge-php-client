...
/**
 * PostObjectSigned Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PostObjectSigned implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['signed_url'] === null) {
            $invalid_properties[] = "'signed_url' can't be null";
        }
    ...
    /**
     * Sets signed_url
     * @param string $signed_url URL created for downloading the object
     * @return $this
     */
    ...
    /**
     * Sets expiration
     * @param int $expiration Value for expiration in minutes
     * @return $this
     */
