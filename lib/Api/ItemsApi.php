...
class ItemsApi extends AbstractApi
{
     ...
     * @throws \AutodeskForge\Client\ApiException on non-2xx response
     * @return \AutodeskForge\Client\Model\Versions
     */
     ...
     * @param int $page_limit specify the maximal number of elements per page (optional)
     * @throws \AutodeskForge\Client\ApiException on non-2xx response
     * @return array of \AutodeskForge\Client\Model\Versions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemVersionsWithHttpInfo($project_id, $item_id, $filter_type = null, $filter_id = null, $filter_extension_type = null, $filter_version_number = null, $page_number = null, $page_limit = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->callApi(
                ...
                $httpBody,
                $headerParams,
                '\AutodeskForge\Client\Model\Versions',
                '/data/v1/projects/{project_id}/items/{item_id}/versions'
            );

            return [
                $this->apiClient->getSerializer()->deserialize($response, '\AutodeskForge\Client\Model\Versions', $httpHeader),
                $statusCode,
                $httpHeader,
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\AutodeskForge\Client\Model\Versions', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\AutodeskForge\Client\Model\BadInput', $e->getResponseHeaders());
     ...
     *
     * @param string $project_id the &#x60;project id&#x60; (required)
     * @param \AutodeskForge\Client\Model\CreateItem $body describe the item to be created (required)
     * @throws \AutodeskForge\Client\ApiException on non-2xx response
     * @return \AutodeskForge\Client\Model\ItemCreated
     */
     ...
     * @param \AutodeskForge\Client\Model\CreateItem $body describe the item to be created (required)
     * @throws \AutodeskForge\Client\ApiException on non-2xx response
     * @return array of \AutodeskForge\Client\Model\ItemCreated, HTTP status code, HTTP response headers (array of strings)
     */
    public function postItemWithHttpInfo($project_id, $body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->callApi(
                ...
                $httpBody,
                $headerParams,
                '\AutodeskForge\Client\Model\ItemCreated',
                '/data/v1/projects/{project_id}/items'
            );

            return [
                $this->apiClient->getSerializer()->deserialize($response, '\AutodeskForge\Client\Model\ItemCreated', $httpHeader),
                $statusCode,
                $httpHeader,
            ];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\AutodeskForge\Client\Model\ItemCreated', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\AutodeskForge\Client\Model\BadInput', $e->getResponseHeaders());
